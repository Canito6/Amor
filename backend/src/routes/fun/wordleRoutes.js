...
router.post('/duel/set-word', (req, res, next) => wordleController.setDuelWord(req, res, next));
router.post('/duel/guess', (req, res, next) => wordleController.makeDuelGuess(req, res, next));
