...
const ScratchCard = require('../scratchCards/scratchCard.model');
const BucketItem = require('../bucketList/bucketItem.model');
...
const LikelyQuestion = require('../likely/likely.model');
